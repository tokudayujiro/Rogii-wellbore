...
**exp009 combined_rich = CV 7.971 / Public LB 8.602**（kernel v9, `MODEL="combined"`）。
carry_forward(12.81/15.88) から CV −38% / LB −46%。参考 NB(LB 7.168) は複数 PF 変種＋
多段スタッキングのアンサンブル幅による正当スコア。
