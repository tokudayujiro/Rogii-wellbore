...
| 7 | 2026-06-29 | combined (hybrid + 0.25·CatBoost残差) | v8 | 8.027 (773 OOF) | 採点中 | — | exp008。base=selector hybrid + CatBoost 残差。sub ref 54169305 |
| 8 | 2026-06-29 | combined_rich (hybrid + 0.4·CatBoost残差, rich特徴) | v9 | **7.971** (773 OOF) | 採点中 | — | exp009。残差特徴+9（pf_beam_diff 等）。CV 全実験ベスト。sub ref 54171532 |
